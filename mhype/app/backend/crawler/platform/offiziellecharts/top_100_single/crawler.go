...
const (
	chartURL  = "https://www.offiziellecharts.de/charts/single"
	crawlerID = "offiziellecharts-top-100-single"
	chartName = "Offizielle Top 100 Single"
	country   = "DE"
)
...
func (impl) Source() string          { return "offiziellecharts.de" }
...
func (impl) Crawl(ctx context.Context, client *http.Client) (crawler.CrawlResult, error) {
	...
	if res.StatusCode < 200 || res.StatusCode >= 300 {
		return crawler.CrawlResult{}, fmt.Errorf("offiziellecharts: %s", res.Status)
	}
