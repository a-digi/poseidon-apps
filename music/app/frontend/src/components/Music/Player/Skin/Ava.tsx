...
const AvaPlayer: React.FC<PlayerAvaProps> = ({
  handleNext,
  currentTrack,
  cover,
  progress,
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="flex items-center justify-center gap-8 w-full mt-4">
          ...
          <button
            ...
            className={`rounded-full w-16 h-16 flex items-center justify-center shadow-xl border-2 border-blue-200 transition text-3xl ${
              !currentTrack
              ...
              {showModeDropdown && (
                ...
                >
                  {playModeOptions.map((opt) => (
                    <button
                      key={opt.value}
                      className={`flex items-center justify-center p-2 hover:bg-blue-100 transition ${
                        playMode === opt.value ? 'text-green-600' : 'text-blue-600'
                      }`}
                      onClick={() => {
